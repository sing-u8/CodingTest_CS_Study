...
| 플랫폼 | 패턴 | 예시 |
|--------|------|------|
| 백준 | `B_<문제번호>_<간단설명>.java\|js\|ts` | `B_1197_최소스패닝트리.java` |
| LeetCode | `LC_<문제번호>_<slug>.js\|ts` | `LC_0042_trapping-rain-water.js` |
| 프로그래머스 | `P_<레벨>_<문제명>.java\|js\|sql` | `P_3_가장먼노드.java` |
